...
function MayorCards() {
  const [mayor] = useState("Bill de Blasio");
    ...
    <div classname="mayors-container">
      <div className="all-mayors">
        <div className="deblasio-container mayors">
          ...
          <p className="mayor-description">
            109th Mayor of New York City, Bill de Blasio, came into office in
            2014 determined to ensure that this city remains a place for
            everyone
          </p>
        ...
        <div className="neil-container mayors">
          ...
          <p className="mayor-description">
            Tyler Loves trees, he believes that GA should go completely green.
            Tyler also believes in the banning of all androids
          </p>
          <div className="mayor-button-container">
            <button className="mayor-button mayor-contact">Contact Me</button>
            <button className="mayor-button mayor-learnmore">Learn More</button>
        ...
        <div className="tyler-container mayors">
          ...
          <p className="mayor-title">Mayor, General Assembly</p>
          <p className="mayor-description">
            Neil loves fibonacci styled poker games and shipping container
            metaphors
          </p>
          <div className="mayor-button-container">
            <button className="mayor-button mayor-contact">Contact Me</button>
