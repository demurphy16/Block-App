        ...
        <div className="rep-container">
          ...
          <div className="rep rep2">
            ...
            <p className="rep-description">
              Whether at home in New York or in Washington, DC, my job is to fight for the 
              people of the 8th Congressional District. That means working to create more
              affordable housing, reform our broken criminal justice system, lower 
              prescription drug prices and ensure all Americans have acces to a high
              quality education.
            </p>
          </div>
        </div>
